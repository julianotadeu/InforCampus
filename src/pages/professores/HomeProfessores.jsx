...
const HomeProfessores = () => {
    ...
    return (
        <div className="home-container">
            ...
            <div className="menu">
                <button onClick={() => handleNavigation('/calendarioProfessores')}>
                    <img src="/InforCampus/calendario.png" alt="Icone do Calendário" />
                    Calendário
                </button>
                <button onClick={() => handleNavigation('/forumProfessores')}>
                    <img src="/InforCampus/forum.png" alt="Icone do Fórum" />
                    Fórum
                </button>
                <button onClick={() => handleNavigation('/perfilProfessores')}>
                    <img src="/InforCampus/perfil.png" alt="Icone do Perfil" />
                    Perfil
                </button>
                <button onClick={() => handleNavigation('/notificacoesProfessores')}>
